<template>
    <div class="h-screen bg-gray-800 flex flex-col">
        ...
        <div class="flex w-full">
            <div class="bg-white w-48 ml-20 h-40 rounded-lg">
            ...
            <div class="grid gap-1 absolute ml-80 w-full text-center rounded">
                ...
                <div v-for="offer in offers" :key="offer" class="grid grid-cols-3">
